...
import com.dilaratatlisu.javamaps.view.LoginActivity;
import com.dilaratatlisu.javamaps.view.MainActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public UserAdapter(Context mContext, List<User> mUsers, boolean isFragment, FirebaseUser firebaseUser) {
        this.mContext = mContext;
        this.mUsers = mUsers;
        this.isFragment = isFragment;
